  ...
  return {
    ...
    clearFilde: function () {
      ...
      fields = document.querySelectorAll(
        domString.descriptionData + ', ' + domString.valueData
      );
    ...
    displayCurrentDate: function () {
      ...
      document.querySelector(domString.dateLebel).textContent =
